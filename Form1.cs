...
namespace Simple_Face_Recognition_App
{
    public partial class Form1 : Form
    {
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"C:\Users\Acer\Downloads\New folder (7)\Simple-Face-Recognition-App-CS-master\Simple Face Recognition App\haarcascade_frontalface_alt.xml");
                        ...
                        foreach (var face in faces)
                        {
                           ...
                           // CvInvoke.Rectangle(currentFrame, face, new Bgr(Color.Red).MCvScalar, 2);
                            ...
                            if (isTrained)
                            {
                                ...
                                {
                                    CvInvoke.PutText(currentFrame, txtPersonName.Text, new Point(face.X - 2, face.Y - 2),
                                        FontFace.HersheyComplex, 1.0, new Bgr(Color.Orange).MCvScalar);
                                    CvInvoke.Rectangle(currentFrame, face, new Bgr(Color.Red).MCvScalar, 2);
        ...
        {
            label1.Text = "Your attendence has been marked successfully";
        ...
        private void MoveBar_MouseMove(object sender, MouseEventArgs e)
        {
            if (MouseMove_Hold == 1)
            {
                this.SetDesktopLocation(MousePosition.X - MouseMoveX, MousePosition.Y - MouseMoveY);
            }
        }
